...
if __name__ ==  '__main__':
    ...
    input_group.add_argument('--dir_input', type=str, help='Input directory with the scans',default='/Users/luciacev-admin/Documents/Projects/Benchmarks/MSDRL_benchmark/data/patients')
    input_group.add_argument('--dir_output', type=str, help='Input directory with the scans',default='/Users/luciacev-admin/Desktop/test')
